        ...
        <div class="container mx-auto bg-white w-full">
            ...
            <div style="max-width:700px; margin: 30px auto;">
                <div class="flex items-center">
                    ...
                    <div class="mt-6">
                       @livewire('seguridad.permiso.crear-permiso')
                    </div>
                                                ...
                                                @foreach($permisos as $permiso)
                                                    <tr class="border-b border-gray-200 bg-gray-100">
                                                        <td class="py-3 px-6 text-center whitespace-nowrap">
                                                            <div class="flex items-center">
                                                            <span
                                                                class="font-medium uppercase">{{ $permiso->id}}</span>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td class="py-3 px-6 text-center whitespace-nowrap">
                                                            <div class="flex items-center">
                                                                <span class="font-medium uppercase">{{$permiso->name}}</span>
                                                            </div>
                                                        </td>
                                                        <td class="py-3 px-6 text-center">
                                                            <div class="flex item-center justify-center">
                                                                <div class="mr-2">
                                                                    @livewire('seguridad.roles.editar-rol',['permiso'=>$permiso],key($permiso->id))
                                                                </div>
                                                                <div
                                                                class=" mr-2  transform hover:text-purple-500 hover:scale-110 uppercase">
                                                                <a onclick="confirm('Estas Seguro de Eliminar A {{$permiso->name}}!')||event.stopImmediatePropagation()"
                                                                   wire:click="destroy({{$permiso->id}})">
                                                                    <button
