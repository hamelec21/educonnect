        ...
        <div class="container mx-auto bg-white w-full">
            ...
            <div style="max-width:700px; margin: 30px auto;">
                <div class="flex items-center">
                    ...
                    <div class="mt-6">
                        @livewire('seguridad.usuario.crear-usuario')
                    </div>
                                                    ...
                                                    @foreach ($usuarios as $usuario)
                                                        <tr class="border-b border-gray-200 bg-gray-100">
                                                            <td class="py-3 px-6 text-center whitespace-nowrap">
                                                                <div class="flex items-center">
                                                                    <span
                                                                        class="font-medium uppercase">{{ $usuario->id }}</span>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="py-3 px-6 text-center whitespace-nowrap">
                                                                <div class="flex items-center">
                                                                    <span
                                                                        class="font-medium uppercase">{{ $usuario->name }}</span>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class= "py-3 px-6 text-center whitespace-nowrap">
                                                                @forelse ($usuario->roles as $role)
                                                                    <div class="flex items-center">
                                                                        <span
                                                                            class=" bg-sky-600 py-1 px-2 text-white rounded-lg uppercase">{{ $role->name }}</span>
                                                                    </div>
                                                                @empty
                                                                    <div class="flex items-center">
                                                                        <span
                                                                            class="bg-red-600 py-1 px-2 text-white rounded-lg uppercase">No
                                                                            roles</span>
                                                                    </div>
                                                                @endforelse
                                                            </td>
                                                            ...
                                                            <td class="py-3 px-6 text-center whitespace-nowrap">
                                                                <div class="flex items-center">
                                                                    <span
                                                                        class="font-medium uppercase">{{ $usuario->email }}</span>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="py-3 px-6 text-center">
                                                                <div class="flex item-center justify-center">
                                                                    <div class="mr-2">
                                                                        @livewire('seguridad.usuario.editar-usuario', ['usuario' => $usuario], key($usuario->id))
                                                                    </div>
                                                                    <div
                                                                        class=" mr-2  transform hover:text-purple-500 hover:scale-110 uppercase">
                                                                        <a onclick="confirm('Estas Seguro de Eliminar A {{ $usuario->name }}!')||event.stopImmediatePropagation()"
