        ...
        <div class="container mx-auto bg-white w-full">
            ...
            <div style="max-width:700px; margin: 30px auto;">
                <div class="flex items-center">
                    ...
                    <div class="mt-6">
                       @livewire('seguridad.roles.crear-rol')
                    </div>
                                                ...
                                                @foreach($roles as $rol)
                                                    <tr class="border-b border-gray-200 bg-gray-100">
                                                        <td class="py-3 px-6 text-center whitespace-nowrap">
                                                            <div class="flex items-center">
                                                            <span
                                                                class="font-medium uppercase">{{ $rol->id}}</span>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td class="py-3 px-6 text-center whitespace-nowrap">
                                                            <div class="flex items-center">
                                                                <span class="font-medium uppercase">{{$rol->name}}</span>
                                                            </div>
                                                        </td>
                                                        <td class="py-3 px-6 text-center">
                                                            <div class="flex item-center justify-center">
                                                                <div class="mr-2">
                                                                    @livewire('seguridad.roles.editar-rol',['rol'=>$rol],key($rol->id))
                                                                </div>
                                                                <div
                                                                class=" mr-2  transform hover:text-purple-500 hover:scale-110 uppercase">
                                                                <a onclick="confirm('Estas Seguro de Eliminar A {{$rol->name}}!')||event.stopImmediatePropagation()"
                                                                   wire:click="destroy({{$rol->id}})">
                                                                    <button
