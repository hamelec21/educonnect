<div>
    ...
    <div class="text-2xl text-center mt-10 uppercase">Carro N° 1</div>
    <div class="w-2/3 px-2 py-1 mx-auto max-w-7x sm:px-6 lg:px-8 ">

        {{--print_r($selected)--}}
        <table class="w-full divide-y divide-gray-200  mt-10">
            <div class="flex justify-center">
                <button class="btn-confirmar" wire:click="confirmar">Confimar</button>
            </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-3 py-2 text-center whitespace-nowrap">
                            <input type="checkbox" wire:model="selected" value="{{ $item->id }}"{{ $item->status_id == 2 ? 'disabled' : '' }}>
                        ...
                        <td class="px-3 py-4 text-center whitespace-nowrap">
                            ...
                            <span class="relative inline-block px-3 py-1 font-semibold leading-tight text-red-900">
                                ...
                                <span class="relative">Prestado</span>
                            </span>
                            @else
