<div>
    ...
    <div class="text-white bg-gradient-to-r from-green-800 to-green-400 h-24">
            ...
            <div class="container mx-auto bg-gray-200 rounded-lg mt-10">
                        ...
                        <div id="alerta" class="flex items-center  text-white text-sm font-bold px-4 py-2  mb-5" role="alert">
                            ...
                            <div class="text-center">
                                ...
                                <button class="btn-entrega px-4 py-2 rounded-lg w-1/2 mb-5 "wire:click="buscar">Entrega</button>
